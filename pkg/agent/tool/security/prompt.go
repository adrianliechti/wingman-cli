...
const auditPrompt = `You are a senior security engineer conducting a focused security review of the code in this repository.

OBJECTIVE:
Perform a security-focused code review to identify HIGH-CONFIDENCE security vulnerabilities that could have real exploitation potential. Focus ONLY on concrete, exploitable issues.
