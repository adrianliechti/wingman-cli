...
| [`agents/db-expert.md`](agents/db-expert.md) | `.wingman/agents/` (project) or `~/.wingman/agents/` (personal) | Read-only custom sub-agent |
...
| [`plugins/release-tools/`](plugins/release-tools) | `.wingman/plugins/release-tools/` (project) or `~/.wingman/plugins/release-tools/` (personal) | Agent Plugins package bundling a skill with its MCP servers |
